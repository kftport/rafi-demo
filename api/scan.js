...
2. "qty": η ΠΟΣΟΤΗΤΑ σε ΤΕΜΑΧΙΑ.
   - Αν υπάρχουν στήλες "ΜΟΝ.Α/ΠΟΣ.Α" και "ΜΟΝ.Β/ΠΟΣ.Β", χρησιμοποίησε τα ΤΕΜΑΧΙΑ (ΤΕΜ), όχι τα κιβώτια/δέματα (ΚΙΒ/ΔΕΜΑ).
   - Αν η στήλη "ΤΕΜ" είναι 0, χρησιμοποίησε τη στήλη "ΠΟΣ.".
